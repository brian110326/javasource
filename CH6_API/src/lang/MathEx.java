...
// java.lang : 기본 패키지이기 때문에 import 구문이 필요X

// java.lang.Math : 기본적인 수학 계산에 유용한 메소드로 구성되어 있는 클래스
// static 메소드, 변수 ==> 클래스이름.메소드 , 클래스이름.변수
// static final : 상수
public class MathEx {
  ...
  public static void main(String[] args) {
    ...
    // ceil() : 올림
    // floor() : 버림
    // rint() : 반올림 ==> doulbe 타입 리턴
    // round() : 반올림 ==> long or int 타입 리턴
